...
from xknxmono.models.files.v23.registration_info_t_registration_key import (
    RegistrationInfoRegistrationKey,
)
from xknxmono.models.files.v23.registration_status_t import RegistrationStatus
