...
from xknxmono.models.files.v23.module_def_static_t_parameters_union_memory import (
    ModuleDefStaticParametersUnionMemory,
)
from xknxmono.models.files.v23.module_def_static_t_parameters_union_property import (
