...
from xknxmono.models.files.v23.module_def_load_procedures_t import (
    ModuleDefLoadProcedures,
)
from xknxmono.models.files.v23.module_def_static_t_allocators import (
    ModuleDefStaticAllocators,
)
from xknxmono.models.files.v23.module_def_static_t_com_object_refs import (
    ModuleDefStaticComObjectRefs,
)
from xknxmono.models.files.v23.module_def_static_t_com_objects import (
    ModuleDefStaticComObjects,
)
from xknxmono.models.files.v23.module_def_static_t_parameter_calculations import (
    ModuleDefStaticParameterCalculations,
)
from xknxmono.models.files.v23.module_def_static_t_parameter_refs import (
    ModuleDefStaticParameterRefs,
)
from xknxmono.models.files.v23.module_def_static_t_parameter_validations import (
    ModuleDefStaticParameterValidations,
)
from xknxmono.models.files.v23.module_def_static_t_parameters import (
