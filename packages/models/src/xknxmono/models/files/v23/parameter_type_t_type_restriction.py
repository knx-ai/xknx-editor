...
from xknxmono.models.files.v23.parameter_type_t_type_restriction_base import (
    ParameterTypeTypeRestrictionBase,
)
from xknxmono.models.files.v23.parameter_type_t_type_restriction_enumeration import (
    ParameterTypeTypeRestrictionEnumeration,
)
from xknxmono.models.files.v23.parameter_type_t_type_restriction_uihint import (
