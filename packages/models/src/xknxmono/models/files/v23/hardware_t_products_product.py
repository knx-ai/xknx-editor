...
from xknxmono.models.files.v23.hardware_t_products_product_attributes import (
    HardwareProductsProductAttributes,
)
from xknxmono.models.files.v23.hardware_t_products_product_baggages import (
