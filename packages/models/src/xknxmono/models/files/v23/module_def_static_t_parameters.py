...
from xknxmono.models.files.v23.module_def_static_t_parameters_parameter import (
    ModuleDefStaticParametersParameter,
)
from xknxmono.models.files.v23.module_def_static_t_parameters_union import (
