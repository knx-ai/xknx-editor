...
from xknxmono.models.files.v23.parameter_type_t_type_ipaddress_address_type import (
    ParameterTypeTypeIpaddressAddressType,
)
from xknxmono.models.files.v23.parameter_type_t_type_ipaddress_version import (
