...
from xknxmono.models.files.v23.hawk_configuration_data_t_memory_segments_memory_segment_access_rights import (
    HawkConfigurationDataMemorySegmentsMemorySegmentAccessRights,
)
from xknxmono.models.files.v23.memory_type_t import MemoryType
