...
from xknxmono.models.files.v23.ld_ctrl_compare_base_t import LdCtrlCompareBase
from xknxmono.models.files.v23.ld_ctrl_mem_addr_space_t import LdCtrlMemAddrSpace
