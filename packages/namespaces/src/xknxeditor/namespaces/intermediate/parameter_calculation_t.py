...
from xknxeditor.namespaces.intermediate.parameter_calculation_t_lparameters import (
    ParameterCalculationLparameters,
)
from xknxeditor.namespaces.intermediate.parameter_calculation_t_rparameters import (
