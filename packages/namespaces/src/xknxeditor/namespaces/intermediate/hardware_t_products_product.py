...
from xknxeditor.namespaces.intermediate.hardware_t_products_product_attributes import (
    HardwareProductsProductAttributes,
)
from xknxeditor.namespaces.intermediate.hardware_t_products_product_baggages import (
