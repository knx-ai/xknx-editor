...
from xknxeditor.namespaces.intermediate.mask_version_t_downward_compatible_masks import (
    MaskVersionDownwardCompatibleMasks,
)
from xknxeditor.namespaces.intermediate.mask_version_t_management_model import (
    MaskVersionManagementModel,
)
from xknxeditor.namespaces.intermediate.mask_version_t_mask_entries import (
