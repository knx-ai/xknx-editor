...
from xknxeditor.namespaces.intermediate.application_program_dynamic_t import (
    ApplicationProgramDynamic,
)
from xknxeditor.namespaces.intermediate.application_program_ipconfig_t import (
...
from xknxeditor.namespaces.intermediate.application_program_t_cloud_connect import (
    ApplicationProgramCloudConnect,
)
from xknxeditor.namespaces.intermediate.application_program_t_min_ets_version import (
    ApplicationProgramMinEtsVersion,
)
from xknxeditor.namespaces.intermediate.application_program_t_module_defs import (
    ApplicationProgramModuleDefs,
)
from xknxeditor.namespaces.intermediate.application_program_t_profile import (
