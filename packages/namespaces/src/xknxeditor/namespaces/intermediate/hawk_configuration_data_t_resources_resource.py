...
from xknxeditor.namespaces.intermediate.hawk_configuration_data_t_resources_resource_access_rights import (
    HawkConfigurationDataResourcesResourceAccessRights,
)
from xknxeditor.namespaces.intermediate.hawk_configuration_data_t_resources_resource_resource_type import (
