...
:mod:`xknxmono.download` writes them - at the application's code-segment addresses
...
from xknxmono.download.errors import LoadStateError, VerificationError
...
async def read_property_values(
    ...
    """
    from xknxmono.product.parser_v2.application_indexer import ApplicationIndexer
    from xknxmono.product.parser_v2.encode import collect_writes
