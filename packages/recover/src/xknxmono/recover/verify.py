...
is actually on the device using :func:`xknxmono.download.preflight`. A clean result
...
from xknxmono.download import DownloadScope, GroupCommunication, GroupObjectLink
from xknxmono.download.download import preflight
...
if TYPE_CHECKING:
    ...
    from xknxmono.download import PreflightReport
...
def build_group_communication(
    ...
    """
    from xknxmono.download.tables import com_object_flag_byte
