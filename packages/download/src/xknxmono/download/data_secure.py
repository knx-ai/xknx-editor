...
ETS uses for device programming: the device accepts frames from any tool
...
S-A_Sync request before the first S-A_Data frame - the step ETS performs
(DM_SecureSync, 3/5/2).
"""
...
class SecureManagement:
    ...
    connection-oriented mode ETS uses the B0 block includes the TPCI octet
