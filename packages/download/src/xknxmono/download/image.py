...
class GroupCommunication:
    ...
    # :mod:`xknxmono.download.filter_table`). When set, the image writes it into the Router
...
def _resolved_group_object_descriptors(
    ...
    """
    from xknxmono.product.parser_v2.ui import UiComObject, UiParameterBlock, UiTab
...
def _build_com_object_table(
    ...
    ETS/Falcon, whose table follows the group object's ``Active`` flag: a device in,
