...
The expected bytes were read from a Berker BE-GT2Tx.01 (1.1.74) after ETS
programmed it, so these assert the formatters reproduce ETS output exactly.
"""
...
from xknxmono.download.errors import ImageError
