...
from xknxeditor.download.data_secure import SecureProgrammingError
from xknxeditor.download.secure_keyring import (
    device_security_from_keyring,
    load_device_security,
)

# Keyring fixture (MIT-licensed, from the xknx secure test suite, vendored under
# tests/resources/). The device 1.0.0 in it decrypts to this Tool Key with the password "password".
_FIXTURE = Path(__file__).resolve().parent / "resources/testcase.knxkeys"
