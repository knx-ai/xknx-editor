...
are hex. It is the id assigned to a specific version of an application program;
two versions of the same application share manufacturer + application number and
differ in the version segment (and hash).

This module is the string counterpart to :mod:`xknxeditor.recover.identify`, which
