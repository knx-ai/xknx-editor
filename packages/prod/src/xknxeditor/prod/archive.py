...
class Archive:
    ...
    def get_signature(self, manufacturer_id: str) -> bytes | None:
        """Signature bytes for a manufacturer, or None if absent."""
        self._validate_manufacturer_id(manufacturer_id)
    ...
    def close(self) -> None:
        """Close the archive, freeing resources."""
        self._zipfile.close()
