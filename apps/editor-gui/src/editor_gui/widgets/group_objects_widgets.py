...
Complements :class:`~editor_gui.widgets.com_flags_widgets.ComFlagsTable` (which shows only flags) by
...
# Accent colour for the sending group address (ETS shows it emphasised).
...
class GroupObjectsTable:
    ...
    def render(
        ...
        # Bulk action: create + link a group address for every selected com-object (like ETS).
