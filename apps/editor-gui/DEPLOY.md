...
- **xknxmono / editor_gui** — our packages: dynamic imports (parser_v2, model adapters, plugins)
  plus data (KNX XML schemas, i18n `.mo` locales, the app icon + fonts under `assets/`).
